...
const upcomingEvents = [
  ...
  },
  {
    ...
    time: "All Day",
    location: "Kayole & it's environs",
    description: "A day of community outreach.",
    attendees: "100+",
    category: "youth",
  ...
  {
    id: 4,
    title: "World Ambassadors' Day",
    date: "April 4, 2026",
    time: "8:00 AM - 6:00 PM",
    location: "Mwangaza Church",
    description: "This year's theme is saved to serve.",
    attendees: "100+",
    category: "youth",
  ...
  },
  {
    ...
    time: "8:00 AM - 6:00 PM",
    location: "Mwangaza Church",
    description: "A program where children learn more about Christ.",
    attendees: "300+",
    category: "children",
  ...
  },
  {
    ...
    time: "8:00 AM - 6:00 PM",
    location: "Mwangaza Church",
    description: "A day to let our Adventurers enjoy being Adventurers and to show others the blessing they are to our church and our community.",
    attendees: "100+",
    category: "special",
    featured: true,
        ...
        <section className="py-16 bg-gradient-to-br from-slate-50 to-teal-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                { day: "Saturday", time: "10:00 AM", activity: "Main Worship Service", icon: Calendar, description: "Celebrate with us in inspiring worship and biblical teaching" },
                { day: "Wednesday & Friday", time: "6:30 PM - 7:00 PM", activity: "Mid-week Prayer & Bible Study", icon: BookOpen, description: "Mid-week spiritual refreshment and community prayer" },
                { day: "Saturday", time: "9:00 AM", activity: "Youth Sabbath School", icon: Users, description: "Engaging Bible study and fellowship for young people" },
